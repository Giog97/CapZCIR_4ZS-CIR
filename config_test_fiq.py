...
class Config:
    ...
    comment: str = "fiq_val_50epoch_bliplarge_batch16" # nome che viene dato al modello su W&B, originale: "cirr_text_our_2L8H_blipbase"
    dataset: str="fiq" # ['fiq', 'cirr','circo']
    save_path_prefix ='./new' # mod
    
    # eval related
    eval_load_path: str="./new/2025-10-03-DAMtv_cirr_train_50epoch_bliplarge_batch16_best_arithmetic"
    submission_name: str='fiq_our_DAMtv_cirr_train_50epoch_bliplarge_best_arithmetic' # originale
