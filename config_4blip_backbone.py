...
class Config:
    ...
    batch_size: int = 4 # 4 provato e funziona # init 16 you can adjust it according to your GPU memory # Con 16 non gira sulle Dream Machine
    ...
    num_epochs: int = 15 # 100 originale, inizialmente usato 15
    save_best: bool = True
    use_amp: bool = True
