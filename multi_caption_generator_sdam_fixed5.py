...
from model.captioner_sdam_fixed5 import CaptionerSDAM_fixed
import time
import gc
...
CHECKPOINT_INTERVAL = 10  # (inizialmente era 50) Salva più frequentemente per debug
